...
export default function PriceCard({
  ...
  return (
    <div
      data-aos="fade-up"
      className="bg-white hover:shadow-lg transition-all duration-300 rounded-lg p-8 relative border-t-4 border-rose-300"
    >
      ...
      <p className="mt-4 text-gray-600 font-medium">
        ...
        neque unde quibusdam provident temporibus!
      </p>
      <div className="mt-8">
        <div className="text-gray-700 font-semibold text-lg">
          <span className="text-4xl font-bold text-black/90">{price}</span> /
          Month
        </div>
      </div>
      <div className="mt-12">
