    ...
    return (
        <section id='Services' className='py-16'>
            <div className='w-[80%] mx-auto'>
                ...
                <p className='mt-4 w-full sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-1/2 text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur veniam ab sunt fugiat, deserunt amet repudiandae ullam blanditiis distinctio maxime heema is nice?</p>
                {/* Grid */}
